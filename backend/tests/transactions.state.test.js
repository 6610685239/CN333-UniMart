...
describe('GET /api/transactions/user/:userId', () => {
  const mockTransactions = [
    { id: 1, buyerId, sellerId, productId: 10, status: 'PENDING', type: 'SALE', price: 100, product: { id: 10, title: 'Book', price: 100, images: [], status: 'AVAILABLE' }, buyer: { id: buyerId, display_name_th: 'ผู้ซื้อ', username: 'buyer1' }, seller: { id: sellerId, display_name_th: 'ผู้ขาย', username: 'seller1' }, updatedAt: '2025-01-01' },
    { id: 2, buyerId, sellerId, productId: 11, status: 'PROCESSING', type: 'SALE', price: 200, product: { id: 11, title: 'Pen', price: 200, images: [], status: 'Reserved' }, buyer: { id: buyerId, display_name_th: 'ผู้ซื้อ', username: 'buyer1' }, seller: { id: sellerId, display_name_th: 'ผู้ขาย', username: 'seller1' }, updatedAt: '2025-01-02' },
    { id: 3, buyerId, sellerId, productId: 12, status: 'SHIPPING', type: 'RENT', price: 50, product: { id: 12, title: 'Bag', price: 50, images: [], status: 'Reserved' }, buyer: { id: buyerId, display_name_th: 'ผู้ซื้อ', username: 'buyer1' }, seller: { id: sellerId, display_name_th: 'ผู้ขาย', username: 'seller1' }, updatedAt: '2025-01-03' },
    { id: 4, buyerId, sellerId, productId: 13, status: 'COMPLETED', type: 'SALE', price: 300, product: { id: 13, title: 'Phone', price: 300, images: [], status: 'Sold' }, buyer: { id: buyerId, display_name_th: 'ผู้ซื้อ', username: 'buyer1' }, seller: { id: sellerId, display_name_th: 'ผู้ขาย', username: 'seller1' }, updatedAt: '2025-01-04' },
    { id: 5, buyerId, sellerId, productId: 14, status: 'CANCELED', type: 'SALE', price: 150, product: { id: 14, title: 'Hat', price: 150, images: [], status: 'AVAILABLE' }, buyer: { id: buyerId, display_name_th: 'ผู้ซื้อ', username: 'buyer1' }, seller: { id: sellerId, display_name_th: 'ผู้ขาย', username: 'seller1' }, updatedAt: '2025-01-05' }
  ];
